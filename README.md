...
This is the first frame of the point cloud data taken from [RA DIOHEA_D / HOU SE OF_C ARDS](https://github.com/dataarts/radiohead) turned into a particle system with WebGL and three.js. It's not live and probably never will be, so here's a [video dink](https://www.youtube.com/watch?v=VA6qduT4CoI&feature=youtu.be).
